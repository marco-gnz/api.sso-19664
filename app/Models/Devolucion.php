...
class Devolucion extends Model
{
    ...
    protected $fillable = ['uuid', 'inicio_devolucion', 'termino_devolucion', 'observacion', 'color','tipo_contrato', 'pao_id', 'establecimiento_id', 'escritura_id', 'usuario_add_id', 'fecha_add', 'usuario_update_id', 'fecha_update'];
