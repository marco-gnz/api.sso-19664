...
class Escritura extends Model
{
    ...
    protected $fillable = ['uuid', 'escritura_firmada', 'valor_garantia', 'n_resolucion', 'fecha_resolucion', 'observacion', 'especialidad_id', 'usuario_add_id', 'fecha_add', 'usuario_update_id', 'fecha_update'];
